...
export default function Job() {
  ...
  let employeTypeFunction = (value, checked) => {
    if (checked === true) {
      setAllValues({
        ...allValues,
        employeType: [...allValues.employeType, value],
      });
    } else {
      setAllValues({
        ...allValues,
        employeType: allValues.employeType.filter((e) => {
          if (e !== value) {
            return value;
          }
        }),
    ...
    <>
      ...
      <div className="job-sec">
        <div className="filter-job-sec">
          <FilterJob
            EmployeeFun={employeTypeFunction}
            EmpSalary={EmpSalaryFun}
          />
        </div>
        <div className="display-All-job-sec">
          <input
            type="search"
            onKeyDown={onseraEnterInput}
            className="form-control w-75 inputSearch"
