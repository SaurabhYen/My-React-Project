...
export default function DetailComp() {
  ...
  useEffect(() => {
    const userDeatl = async () => {
      ...
      setAllValues({
        ...allValues,
        job_detailsDesc: jobDetailresponse.job_details,
        similarjob: jobDetailresponse.similar_jobs,
        job_life_at_company: jobDetailresponse.life_at_company,
        skillsSec: jobDetailresponse.job_details.skills,
        life_at_companySec: jobDetailresponse.job_details.life_at_company,
      });
      ...
      <li className="job-cards">
        ...
        <div className="job-card-content">
          <div className="jobcard-top-cont">
            <img
              src={allValues.job_detailsDesc.company_logo_url}
              alt=""
          ...
          <div className="location-sec">
            <span className="locaton-desc">
              <p>
                ...
                {allValues.job_detailsDesc.location}{" "}
              </p>
              <p>
                {" "}
                <PiHandbagSimpleFill className="locationIcon" />{" "}
                {allValues.job_detailsDesc.employment_type}
              </p>
            </span>
          ...
          <div className="skill-sec">
            ...
            <ul className="company-name-sec">
              {allValues.skillsSec.map((e) => {
                return (
                  <li key={e.name} className="skils-copnylogo-img">
                    <img
                      src={e.image_url}
                      alt="image_url"
                      className="image_url"
          ...
          <div className="life-at-Com-sec">
            ...
            <div className="com-info-sec">
              ...
              <img
                src={allValues.life_at_companySec.image_url}
                alt=""
                className="cmpn-Img"
              />
            </div>
        ...
        <div className="similarjob-Heading">
          <h3>Similar Job</h3>
        </div>
        <ul className="similar-job-sec">
          {allValues.similarjob.map((e) => {
            return (
              <li key={e.id} className="simliarJob-card">
